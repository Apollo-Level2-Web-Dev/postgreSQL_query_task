...
-- Q9: For each customer, display their full name (first and last name combined),
-- total number of orders, and total amount spent. Order by total amount spent (highest first)

-- Q10: Find the top 3 most expensive books that have been ordered at least once,
-- showing the book title, author, price, and total quantity sold across all orders
